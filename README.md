...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tinysegmenter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14278&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tinysegmenter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tinysegmenter` can be installed with:

```
conda install tinysegmenter
```

It is possible to list all of the versions of `tinysegmenter` available on your platform with:
